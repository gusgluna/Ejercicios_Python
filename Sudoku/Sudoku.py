...
tup_comp = (bloque_01['a1'], bloque_01['b1'],
bloque_01['c1'], bloque_01['d1'], bloque_01['e1'], bloque_01['f1'])
num_rand = random.randint(1,9)
while num_rand in tup_comp:
  num_rand = random.randint(1,9)
bloque_01['g1'] = num_rand
...
print('2║'+str(bloque_01['a2'])+'│'+str(bloque_01['b2'])+'│'+str(bloque_01['c2'])+'║'+str(bloque_01['d2'])+'│'+str(bloque_01['e2'])+'│'+str(bloque_01['f2'])+'║'+str(bloque_01['g2'])+'│'+str(bloque_01['h2'])+'│'+str(bloque_01['i2'])+'║')

print('3║'+str(bloque_01['a3'])+'│'+str(bloque_01['b3'])+'│'+str(bloque_01['c3'])+'║'+str(bloque_01['d3'])+'│'+str(bloque_01['e3'])+'│'+str(bloque_01['f3'])+'║'+str(bloque_01['g3'])+'│'+str(bloque_01['h3'])+'│'+str(bloque_01['i3'])+'║')
